...
test("policy-rate context returns only first-seen, available values as of the cutoff", async () => {
  ...
  assert.equal(result.eligibility, "prospective_oos_eligible");
...
test("carry preflight refuses to invent a long historical sample before first-seen collection", () => {
  const result = carryPanelPreflight({
    asOf: "2026-07-28T13:00:00.000Z", rates: [
      { currency: "USD", status: "available", value: 3.75, available_at: "2026-06-18T00:00:00.000Z", first_seen_at: "2026-07-28T13:00:00.000Z", evidence_tier: "prospective_first_seen" },
      { currency: "EUR", status: "available", value: 2.4, available_at: "2026-06-12T00:00:00.000Z", first_seen_at: "2026-07-28T13:00:00.000Z", evidence_tier: "prospective_first_seen" },
...
test("carry preflight counts only loaded daily price bars that match the fixed regime", () => {
  const result = carryPanelPreflight({
    asOf: "2026-08-31T00:00:00.000Z", rates: [
      { currency: "USD", status: "available", value: 3.75, available_at: "2026-06-18T00:00:00.000Z", first_seen_at: "2026-07-01T00:00:00.000Z", evidence_tier: "prospective_first_seen" },
      { currency: "EUR", status: "available", value: 2.4, available_at: "2026-06-12T00:00:00.000Z", first_seen_at: "2026-07-01T00:00:00.000Z", evidence_tier: "prospective_first_seen" },
...
test("carry preflight filters OOS anchors even before price evidence is loaded", () => {
  const result = carryPanelPreflight({
    asOf: "2026-07-28T00:00:00.000Z", rates: [
      { currency: "USD", status: "available", value: 3.75, available_at: "2006-07-20T00:00:00.000Z", first_seen_at: "2006-07-20T00:00:00.000Z", evidence_tier: "prospective_first_seen" },
      { currency: "EUR", status: "available", value: 2.4, available_at: "2006-07-20T00:00:00.000Z", first_seen_at: "2006-07-20T00:00:00.000Z", evidence_tier: "prospective_first_seen" },
...
test("carry preflight rejects exploratory revised-history evidence", () => {
  assert.throws(() => carryPanelPreflight({
    asOf: "2026-07-28T00:00:00.000Z", rates: [
      { currency: "USD", status: "available", value: 3.75, available_at: "2006-07-20T00:00:00.000Z", first_seen_at: "2006-07-20T00:00:00.000Z", evidence_tier: "exploratory_revised_history" },
    ], pairs: [{ pair_id: "EURUSD", base_currency: "EUR", quote_currency: "USD" }], from: "2006-07-20", to: "2026-07-28", horizonBusinessDays: 20, oosFrom: null, minimumObservations: 1,
  }), /prospective first-seen/);
});
